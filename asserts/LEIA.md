...
| `t-funcionamento-addon` | o Funcionamento Básico e os modelos de Feitiço trazidos pela cópia congelada do addon: validação, namespace, texto, efeito pelo `deriveAfty`, acesso por Nível de Feitiço e isolamento entre combatentes |
