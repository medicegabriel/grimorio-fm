...
/* ⚠ A LISTA É FECHADA de propósito: primitiva nova cai aqui e obriga quem a
   ...
   Carteira da Guilda. Em 2026-09-09 entraram duas: a `criacaoArmas`, com o
   padrão de criação de armas, e a `vislumbreCeleste`, com a Condição Corporal
   dos Seis Olhos.
...
t("sao 20 primitivas", AD.PRIMITIVAS.length, 20);
t("ids esperados", AD.PRIMITIVAS.map((p) => p.id).sort(),
  ["adaptacao", "armaTransformavel", "armasPorNivel", "caracteristicasAmaldicoadas", "carteira", "catarse", "cofre", "concessao", "contar", "criacaoArmas", "encantamentoGuia", "hpAtributo", "modificacoesCorporais", "olhosDeAgulha", "pacto", "pvEPassivas", "quimera", "requisitoAptidao", "titaColosso", "vislumbreCeleste"]);
